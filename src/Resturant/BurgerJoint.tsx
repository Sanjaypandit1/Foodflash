...
const foodItems: FoodItem[] = [
  {
    ...
    name: 'Veg Pizza',
    price: '300',
    description: 'Hand-tossed pizza topped with fresh vegetables, rich tomato sauce, and melted mozzarella cheese. Garnished with fresh basil leaves and a drizzle of olive oil.',
  ...
  },
  {
    ...
    name: 'Veg Momo',
    price: '100',
    description: 'Soft dumplings filled with finely chopped cabbage, carrots, onions, and aromatic spices. Steamed to perfection and served with spicy tomato dipping sauce.',
  ...
  },
  {
    ...
    name: 'Veg Burger',
    price: '120',
    description: 'Crispy vegetable patty with lettuce, tomato, onion, and cheese in a toasted sesame bun. Served with our special house sauce and a side of fries.',
  ...
  },
  {
    ...
    name: 'Veg Biryani',
    price: '250',
    description: 'Fragrant basmati rice cooked with mixed vegetables, saffron, and aromatic spices. Served with raita and papadum. A perfect blend of flavors and textures.',
  ...
  },
  {
    ...
    name: 'Chicken Momo',
    price: '150',
    description: 'Juicy dumplings filled with minced chicken, ginger, garlic, and spring onions. Steamed to perfection and served with a spicy sesame-soy dipping sauce.',
  ...
  },
  {
    ...
    price: '450',
    description: 'Aromatic basmati rice layered with tender chicken pieces, caramelized onions, and authentic spices. Slow-cooked to perfection and garnished with fresh mint and coriander.',
    image: require('../Assets/BurgerJoint/chicken-biryani.jpg'),
    isVeg: false, // Corrected: Chicken Biryani is non-vegetarian
    rating: '4.7',
    preparationTime: '20 min',
  },
];
